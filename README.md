...
3. Allocate 
   #### IP Address 
        1. This PC --> Properties --> Advanced System Settings --> Computer Name
        2. IP Address
        3. Subnet Mask
   #### Default Gateway 
        1. Control Panel --> Network & Internet --> Network and Sharing Center --> Ethernet --> Properties
        2. Preferred DSN Server
        3. Alternet DSN Server
